...
public static class PlayerExtensions
{
    ...
    public static Func<Player, bool> HasAPairOfTwoCards = (Player p) => p.HasASetOfSameCards(2, 2);
    ...
    public static Player FindPlayerWithHighestCard(this IEnumerable<Player> players)
    {
